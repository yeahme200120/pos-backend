...
<template>
    <aside class="w-64 bg-gray-800 text-white flex-shrink-0">
        ...
        <nav class="mt-4">
            <!-- Dashboard -->
            <router-link to="/dashboard" class="flex items-center px-4 py-2 hover:bg-gray-700 transition"
            ...
            <router-link to="/productos" class="flex items-center px-4 py-2 hover:bg-gray-700 transition"
                active-class="bg-gray-700">
            ...
            <router-link to="/clientes" class="flex items-center px-4 py-2 hover:bg-gray-700 transition"
                active-class="bg-gray-700">
            ...
            <router-link to="/ventas" class="flex items-center px-4 py-2 hover:bg-gray-700 transition"
                active-class="bg-gray-700">
                <i class="fas fa-shopping-cart w-5"></i>
                <span class="ml-2">Ventas</span>
                <span class="ml-auto bg-blue-500 text-xs px-2 py-1 rounded-full">{{ totalVentasHoy }}</span>
            </router-link>
            <router-link to="/cajas" class="flex items-center px-4 py-2 hover:bg-gray-700 transition"
                active-class="bg-gray-700">
                <i class="fas fa-cash-register w-5"></i>
                <span class="ml-2">Cajas</span>
            </router-link>

            <router-link to="/mesas" class="flex items-center px-4 py-2 hover:bg-gray-700 transition"
                active-class="bg-gray-700">
            ...
            <router-link to="/reportes" class="flex items-center px-4 py-2 hover:bg-gray-700 transition"
                active-class="bg-gray-700">
            ...
            <router-link to="/configuracion" class="flex items-center px-4 py-2 hover:bg-gray-700 transition"
                active-class="bg-gray-700">
                <i class="fas fa-cog w-5"></i>
                <span class="ml-2">Configuración</span>
            </router-link>

            <router-link to="/ticket-config" class="flex items-center px-4 py-2 hover:bg-gray-700 transition"
                active-class="bg-gray-700">
                <i class="fas fa-receipt w-5"></i>
                <span class="ml-2">Ticket</span>
            </router-link>

            <router-link to="/auditoria" class="flex items-center px-4 py-2 hover:bg-gray-700 transition"
                active-class="bg-gray-700">
