                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr v-for="user in usuarios" :key="user.id" class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-4 py-4 text-sm whitespace-nowrap">
                                ...
                                <span class="inline-flex px-2 py-1 text-xs rounded-full" :class="claseRol(user.rol)">
                                    {{ nombreRol(user.rol) }}
                                </span>
                            ...
                            <td class="px-4 py-4 text-center">
                                ...
                                <span class="inline-flex px-2 py-1 text-xs rounded-full" :class="user.activo
            ...
            <div class="md:hidden space-y-3 p-3">
                ...
                <div v-for="user in usuarios" :key="user.id"
                    ...
                    <div class="flex items-center justify-between px-4 py-3 bg-gray-50 border-b">
                        ...
                        <span class="flex-shrink-0 inline-flex px-2 py-1 text-xs rounded-full" :class="user.activo
                                ? 'bg-green-100 text-green-800'
                                : 'bg-red-100 text-red-800'
                            ">
                            {{ user.activo ? 'Activo' : 'Inactivo' }}
                    ...
                    <div class="px-4 py-3 space-y-3">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <div class="text-right">
                                ...
                                <span v-if="user.empresa" class="inline-flex px-2 py-1 text-xs rounded-full"
                    ...
                    <div class="flex border-t">
                        ...
                        <div v-if="user.empresa_id" class="w-px bg-gray-200"></div>
                ...
                <form @submit.prevent="guardarUsuario">
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input v-model="form.telefono" type="text" maxlength="10" inputmode="numeric"
                                class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                        ...
                        <div>
                            ...
                            <select v-model="form.rol" class="w-full px-3 py-2 border rounded-lg">
                        ...
                        <div>
                            ...
                            <select v-model="form.empresa_id" class="w-full px-3 py-2 border rounded-lg" required>
                ...
                <form @submit.prevent="guardarLicencia">
                    <div class="space-y-4">
                        <div>
                            ...
                            <select v-model="licenciaForm.licencia_tipo" @change="calcularFechaFin"
                                class="w-full px-3 py-2 border rounded-lg" required>
                        ...
                        <div>
                            ...
                            <input v-model="licenciaForm.licencia_fecha_inicio" @change="calcularFechaFin" type="date"
                                class="w-full px-3 py-2 border rounded-lg" required />
                        </div>

                        <div v-if="licenciaForm.licencia_tipo !== 'permanente'">
                            <label class="block text-sm font-medium text-gray-700">
                                Fecha de vencimiento *
                            </label>
                            <input v-model="licenciaForm.licencia_fecha_fin" type="date"
                                class="w-full px-3 py-2 border rounded-lg" required />
                        </div>

                        <div class="flex items-center">
                            <input v-model="licenciaForm.licencia_activa" type="checkbox" class="mr-2" />
                            <label class="text-sm font-medium text-gray-700">
                                Licencia activa
                            </label>
                        </div>

                        <div v-if="licenciaInfo" class="p-4 rounded-lg border bg-gray-50">
                            <p class="text-sm font-semibold text-gray-700">
                                Estado actual
                            </p>

                            <div class="mt-2">
                                <span class="inline-flex px-2 py-1 text-xs rounded-full" :class="licenciaInfo.licencia_vigente
                                        ? 'bg-green-100 text-green-800'
                    ...
                    <div v-if="errorLicencia" class="mt-4 p-3 bg-red-100 text-red-700 rounded-lg text-sm">
                        {{ errorLicencia }}
                    </div>

                    <div class="flex justify-end gap-2 mt-6">
                        <button type="button" @click="cerrarLicencia"
                            class="px-4 py-2 bg-gray-200 rounded-lg hover:bg-gray-300">
                            Cancelar
                        </button>
        ...
        async cargarEmpresas() {
            try {
                ...
                if (
                    ...
                    console.warn(
                        'Formato inesperado en respuesta de empresas:',
                        response.data
                    );
                }
